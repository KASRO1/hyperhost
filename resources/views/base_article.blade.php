...
@section('content')
            ...
            <main class="other_page">  
                <div class="container">
                    <h1><span>{!! __("base.title") !!}</span> {!! __("KNOWLEDGE.title") !!}</h1>
                </div>
            </main>
            ...
            <div class="container other_page article"> 
                <div class="pages">
                    <a href="/">{!! __("main.title") !!}</a> / <a href="{{route('base')}}">{!! __("base.title") !!}</a> / <a href="{{route('base_cat', $base_cat->id)}}">{!! __($base_cat->name) !!}</a> / <span>{!! __($base->title) !!}</span>
                 </div>
                 <div class="item">
                    <div class="date">
                 ...
                 <div class="other">
                    <p class="title">{!! __("Other articles in the section.title") !!}</p>
